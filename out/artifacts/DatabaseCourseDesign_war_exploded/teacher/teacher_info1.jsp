            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="side-menu-container">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active panel panel-default dropdown"><a data-toggle="collapse" href="#dropdown-element1"><span class="icon fa fa-desktop"></span><span class="title">个人信息</span></a>
                            <!-- Dropdown level 1 -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <div class="title"><span class="fa fa-list"></span>&nbsp;教师个人信息</div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div>
                                    <div class="table-responsive">
                                        <table width="100%" class="myCss">
                                            <tbody>
                                                <tr>
                                                    <td colspan="2" rowspan="6" align="center"><img src="chenbaoquan.jpg" height="180" width="120"></td>
                                                    <td align="right" width="16.6%">教师编号：</td>
                                                    <td align="left" width="16.6%">201676000007</td>
                                                    <td align="right" width="16.6%">姓名：</td>
                                                    <td align="left" width="16.6%">陈宝权</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left"></td>
                                                    <td align="right">中学毕业时间：</td>
                                                    <td align="left"></td>
                                                </tr>
                                                <tr>
                                                    <td align="right">大学专业：</td>
                                                    <td align="left"></td>
                                                    <td align="right">本科毕业大学：</td>
                                                    <td align="left"></td>
                                                    <td align="right">大学毕业时间：</td>
                                                    <td align="left"></td>
                                                </tr>
                                                <tr>
                                                    <td align="right">大学学科：</td>
                                                    <td align="left">工学</td>
                                                    <td align="right">硕士生毕业大学：</td>
                                                    <td align="left">纽约州立大学石溪分校</td>
                                                    <td align="right">硕士生毕业时间：</td>
                                                    <td align="left">199912</td>
                                                </tr>
                                                <tr>
                                                    <td align="right">通信地址：</td>
                                                    <td align="left"></td>
                                                    <td align="right">博士生毕业大学：</td>
                                                    <td align="left">纽约州立大学石溪分校</td>
                                                    <td align="right">博士生毕业时间：</td>
                                                    <td align="left">199712</td>
                                                </tr>
                                                <tr>
