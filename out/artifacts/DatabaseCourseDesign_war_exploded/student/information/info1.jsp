                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <div class="title"><span class="fa fa-list"></span>&nbsp;本科生个人学籍信息</div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div>
                                    <div class="table-responsive">
                                        <table width="100%" class="myCss">
                                            <tbody>
                                            <tr>
                                                <td colspan="2" rowspan="6" align="center"><img src="shaomingshan.jpg" height="200" width="120"/></td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">37山东</td>
                                                <td align="right">毕业中学：</td>
                                                <td align="left">枣庄三中<</td>
                                                <td align="right">高考总分：</td>
                                                <td align="left">645</td>
                                            </tr>
                                            <tr>
                                                <td align="right">学位：</td>
                                                <td align="left">&nbsp;</td>
                                                <td align="right">学科门类：</td>
                                                <td align="left">工学</td>
                                                <td align="right">培养方式：</td>
                                                <td align="left">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td align="right">因材施教：</td>
                                                <td align="left">&nbsp;</td>
                                                <td align="right">专业方向：</td>
                                                <td align="left">物联网与嵌入式软件方向</td>
                                                <td align="right">分流方向：</td>
                                                <td align="left">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td align="right">二学位系：</td>
                                                <td align="left"></td>
                                                <td align="right">二学位专业：</td>
                                                <td align="left">&nbsp;</td>
                                                <td align="right">二学位班：</td>
                                                <td align="left">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td align="right">学籍异动：</td>
                                                <td align="left">&nbsp;</td>
                                                <td align="right">宿舍地址：</td>
                                                <td align="left">6#423</td>
                                                <td align="right">毕业日期：</td>
                                                <td align="left">20190630</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
