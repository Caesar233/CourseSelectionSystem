                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="card">
                            ...
                            <form class="card-body" action="/controller/TeacherServlet" method="post">
                                <div class="form-inline" style="margin: 10px">
                                    <div class="form-group" style="margin: 10px">
                                        <label for="tid" style="margin: 10px">工号</label>
                                        <input type="text" class="form-control" id="tid" name="tid" placeholder="请输入工号">
                                    </div>
                                    <div class="form-group" style="margin: 10px">
                                        <label for="tname" style="margin: 10px">姓名</label>
                                ...
                                <div class="form-inline" style="margin: 10px">
                                    ...
                                    <div class="form-group" style="margin: 10px">
                                        <button type="submit" class="btn btn-info">查询教师</button>
                                    </div>
                                </div>
                            </form>
                            <div class="card-header">
                                <div class="card-title">
                                    <div class="title"><span class="glyphicon glyphicon-user"></span>教师信息</div>
                                </div>
                            </div>
                            <div class="card-body" action="/controller/CourseServlet" method="post">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        <th scope="row"><%=i+1%></th>
                                        <td><%=teachers.get(i).getTid()%></td>
                                        <td><%=teachers.get(i).getTname()%></td>
                                        <td><%if (teachers.get(i).getSex() != null) {%>
                                            <%=teachers.get(i).getSex()%>
                                            <%}%>
                                        </td>
                                        <td><%if (teachers.get(i).getAge() != null) {%>
                                            <%=teachers.get(i).getAge()%>
                                            <%}%>
                                        </td>
                                        <td><%if (teachers.get(i).getId() != null) {%>
                                            <%=teachers.get(i).getId()%>
                                            <%}%>
                                        </td>
                                        <td><%if (teachers.get(i).getDept() != null) {%>
                                            <%=teachers.get(i).getDept()%>
                                            <%}%>
                                        </td>
