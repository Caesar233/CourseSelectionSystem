    ...
    <div class="container-fluid">
        <div class="side-body">
            ...
            <div class="page-title">
                ...
                <div class="description">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、下面列出本学期所有课程的成绩，选中某门课程，按“显示排名”按钮，可计算成绩排名。</div>
                <div class="description">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、计算排名的时间会稍长一些，选择排名的课程不要超过20门。</div>
            </div>
        </div>
            <div class="row">
                <div class="col-xs-12">
                            ...
                            <div>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td valign="top" colspan="8">对不起,搜索数据不存在！</td>
                                        </tr>
