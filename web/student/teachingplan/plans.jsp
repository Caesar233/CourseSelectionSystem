            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <div class="title"><span class="fa fa-calendar"></span>&nbsp;教学总体计划要求</div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <div class="title"><span class="fa fa-list"></span>&nbsp;计划课程</div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td style="word-break:break-all;word-wrap:break-word;">形势政策与社会实践</td>
